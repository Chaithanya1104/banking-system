...
public class AddMoneyServlet extends HttpServlet {
    private static final String UPDATE_CUSTOMER_QUERY = "UPDATE customers SET initial_balance = initial_balance + ? WHERE account_number = ?";
    private static final String INSERT_TRANSACTION_QUERY = "INSERT INTO transactions (account_number, transaction_type, amount, transaction_date) VALUES (?, ?, ?, ?)";
