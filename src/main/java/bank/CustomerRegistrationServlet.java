...
public class CustomerRegistrationServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            String insertQuery = "INSERT INTO customers (fullname, address, mobile, email, account_type, dob, id_proof, account_number, password) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            pstmt.setInt(8, accountNo);
            pstmt.setString(9, temporaryPassword);
    ...
    private void insertInitialTransaction(Connection conn, int accountNo, double initialBalance) throws SQLException {
        ...
        String initialTransactionQuery = "INSERT INTO transactions (account_number, transaction_type, amount, transaction_date) VALUES (?, ?, ?, ?)";
        try (PreparedStatement initialTransactionStmt = conn.prepareStatement(initialTransactionQuery)) {
