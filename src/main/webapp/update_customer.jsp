...
<%
    ...
    Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/banking_app", "root", "root");
    Statement stmt = con.createStatement();
    String query = "SELECT * FROM customers WHERE account_number = " + account_no;
...
<form action="update_process.jsp" method="post" onsubmit="return validateForm()">
    ...
    <input type="hidden" name="account_no" value="<%= rs.getString("account_number") %>" />
